...
#ifndef FORMAT_S98_IMPORT_H
#define FORMAT_S98_IMPORT_H

#include "ffmt_base.h"

/**
 * @brief Import from S98 files
 */
class S98_Importer final : public FmBankFormatBase
{
public:
