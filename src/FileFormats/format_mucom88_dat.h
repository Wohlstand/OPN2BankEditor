...
#ifndef FORMAT_MUCOM88_DAT_H
#define FORMAT_MUCOM88_DAT_H

#include "ffmt_base.h"

/**
 * @brief Reader of the Mucom88 File Format
 */
class Mucom88_DAT final : public FmBankFormatBase
{
public:
