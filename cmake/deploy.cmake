...
if(APPLE)
    set(CPACK_PACKAGE_NAME "OPN2 Bank Editor")
    if(NOT CPACK_GENERATOR)
        set(CPACK_GENERATOR "DragNDrop")
    endif()
    set(CPACK_DMG_FORMAT "UDBZ")
    set(CPACK_DMG_VOLUME_NAME "OPN2 Bank Editor")
    if(NOT CPACK_PACKAGE_FILE_NAME)
        set(CPACK_PACKAGE_FILE_NAME "opn2-bank-editor")
    endif()
    include(CPack)
...
elseif(UNIX)
    ...
    set(CPACK_DEBIAN_PACKAGE_NAME "opn2-bank-editor")
    set(CPACK_DEBIAN_PACKAGE_VERSION ${OPN2_BANK_EDITOR_VERSION_STRING})
